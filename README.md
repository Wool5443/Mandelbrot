...
|:---------|:-------------------:|:-----------------|
Naive   -O0|100                |70280350503 ≈ 7.02 * 10^10
Arrays  -O0|100                |964831568137 ≈ 9.65 * 10^11
AVX512  -O0|100                |20718015093 ≈ 2.07 * 10^10

* $\frac{\text{Naive}}{\text{Arrays}} = 0.07284$
* $\frac{\text{Naive}}{\text{AVX}} = 3.392$
* $\frac{\text{Arrays}}{\text{AVX}} = 46.57$

Реализация | Количество прогонов | Количество Тиков |
|:---------|:-------------------:|:-----------------|
Naive   -O1|100                  |35088279006 ≈ 3.51 * 10^10
Arrays  -O1|100                  |310773914986 ≈ 3.11 * 10^11
AVX512  -O1|100                  |5965031906 ≈ 5.97 * 10^9

* $\frac{\text{Naive}}{\text{Arrays}} = 0.1129$
* $\frac{\text{Naive}}{\text{AVX}} = 5.882$
* $\frac{\text{Arrays}}{\text{AVX}} = 52.1$

Реализация | Количество прогонов | Количество Тиков |
|:---------|:-------------------:|:-----------------|
Naive   -O2|100                  |32595339515 ≈ 3.26 * 10^10
Arrays  -O2|100                  |103511545314 ≈ 1.94 * 10^11
AVX512  -O2|100                  |5498534759 ≈ 5.50 * 10^9

* $\frac{\text{Naive}}{\text{Arrays}} = 0.3149$
* $\frac{\text{Naive}}{\text{AVX}} = 5.928$
* $\frac{\text{Arrays}}{\text{AVX}} = 18.83$
