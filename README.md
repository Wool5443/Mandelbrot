...
------------|-----------------------------------------------|-----------------------------------------------|---------------------------------------
0			|$6.3428 * 10^{10} \pm 0.1800 * 10^{10}$		|$1.1013 * 10^{11} \pm 0.0160 * 10^{11}$		|$1.8001 * 10^{10} \pm 0.1800 * 10^{10}$
1			|$3.1175 * 10^{10} \pm 0.0029 * 10^{10}$		|$3.7582 * 10^{10} \pm 0.0950 * 10^{10}$		|$5.1192 * 10^{9} \pm 0.0290 * 10^{9}$
2			|$2.8013 * 10^{10} \pm 0.0130 * 10^{10}$		|$1.3001 * 10^{10} \pm 0.0025 * 10^{10}$		|$4.7496 * 10^{9} \pm 0.1300 * 10^{9}$
3			|$2.8052 * 10^{10} \pm 0.0120 * 10^{10}$		|$1.2192 * 10^{10} \pm 0.0140 * 10^{10}$		|$4.5913 * 10^{9} \pm 0.1200 * 10^{9}$
